...
async def on_message(message):
    ...
    embed = discord.Embed(
        title="DCP Worker",
        url=embed_url,
        description=f"{message_prefix} fren! This link allocates your unused CPU to be used by the distributed compute protocol. Change the address to earn credits to your account! Why not contribute to a super computer while you're not chatting??",
        color=0xFF5733,
    )
